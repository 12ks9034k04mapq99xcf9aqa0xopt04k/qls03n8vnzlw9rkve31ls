...
//=========================================================================
    (function(window){
        var vars = {
            ...
            tempmlibrary: ["","",""],
            library: "",
            excludelibrary0: false,
            excludelibrary1: false,
            excludelibrary2: false,
            excludelibrary3: false,
            commands:"",
            log: "",
            logpresent: false,
            logopen: false,
...
//=========================================================================
    (function(window){
        var st = {};
        st.d = {b:"thebody", mi:"maininputdiv",ba:"buttonarea", rv:"recieverdiv", lr:"librarydiv", lg:"logdiv", mlg:"malogdiv", cmd:"commandsdivision"};
    ...
    (function(window){
		...
		f.lh = function () {
                ...
                f.library = function() {
                    ...
                    var txt2 = "";
                    var txt3 = "";
                    if (vars.excludelibrary0 === false) {
                        if (vars.excludelibrary1 === false) {
                            txt1 = vars.mlibrary[0];
                        };
                        if (vars.excludelibrary2 === false) {
                            txt2 = vars.mlibrary[1];
                        };
                        if (vars.excludelibrary3 === false) {
                            txt3 = vars.mlibrary[2];
                        }; 
                    };
...
//=========================================================================
    (function(window){
		...
		dom.uca(st.h.bn, "rvlb", "Library", st.d.ba, st.a.oc, "lr.ls()");
                dom.s("rvlb","padding", "2px");
                dom.s("rvlb","margin", "2px");
		dom.s("rvlb", "backgroundColor", vars.theme[vars.themeBC]);
		dom.s("rvlb", "color", "white");
                dom.uca(st.h.bn, "rvlog", "Commands",st.d.ba, st.a.oc, "commands()");
                dom.s("rvlog","padding", "2px");
                dom.s("rvlog","margin", "2px");
		dom.s("rvlog", "backgroundColor", vars.theme[vars.themeBC]);
		dom.s("rvlog", "color", "white");
            };
            f.ex = function () {
                vars.input = dom.gv("rv.i");
            ...
            f.library = function(id,exclude) {
                if (exclude === undefined) {
                    ...
                    if (id === undefined || id === 0) {
                        vars.excludelibrary0 = exclude;
                    }else if (id === 1) {
                        vars.excludelibrary1 = exclude;
                    }else if (id === 2) {
                        vars.excludelibrary2 = exclude;
                    }else if (id === 3) {
                        vars.excludelibrary3 = exclude;
                    };
                };
            };
