...
//=========================================================================
    (function(window){
        var st = {};
        st.d = {b:"thebody", mi:"maininputdiv",ba:"buttonarea", rv:"recieverdiv", lr:"librarydiv", lg:"logdiv", mlg:"malogdiv", cmd:"commandsdivision", mr: "morebuttonsdivision"};
    ...
    (function(window){
        function rvfunctions() {
            ...
            f.cr = function () {
                ...
                rv.btns();
                dom.ac(st.d.mr);
                if (vars.hidemore === false) { rv.more();};
                vars.currentrv = 1;
		...
		dom.uca(st.h.bn, "rvlb", "More...", st.d.ba, st.a.oc, "rv.rmore()");
		...
		dom.s("rvlb", "color", "white");
            ...
            f.more = function () {
                ...
                dom.uca(st.h.bn, "mrbd", "Commands", st.d.mr, st.a.oc, "commands()");
